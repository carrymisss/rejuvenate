				...
				<Row gutter={30} justify="center">
					<Col>
						<Row justify="space-between" align="middle" gutter={[0, 16]} style={{ "margin": "0" }}>
							<Col>
								<Link className="c-header__brand c-header__brand_big" to="/">
									<svg xmlns="http://www.w3.org/2000/svg" style={{ "marginRight": "5px", "verticalAlign": "middle" }} width="30" height="30" viewBox="0 0 400.174 400.174">
